...
class LSTM(nn.Module):
    ...
    def __str__(self):
       return f"LSTM: number of layers={self.layer_dim}, hidden layers size={self.hidden_dim}"

  
def train_model(data_loader, model, loss_function, optimizer, training_epochs):
